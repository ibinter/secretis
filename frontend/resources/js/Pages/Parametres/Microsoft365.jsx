...
export default function Microsoft365({ auth, microsoftStatus = null }) {
    ...
    const SectionCard = ({ icon: Icon, title, description, iconColor = 'text-purple-600', children }) => (
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {microsoftStatus.scopes.map(scope => (
                                    <span key={scope} className="px-2 py-0.5 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-xs rounded-md font-mono">
                                        {scope}
                                    </span>
                                ))}
                            </div>
                    ...
                    {settings.onedrive_sync_enabled && isConnected && (
                        ...
                        >
                            <input
                                ...
                                className="w-64 px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                            />
                        </SettingRow>
                    )}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                ...
                                Consultez le{' '}
                                <a href="/docs/microsoft-365-integration" className="text-purple-600 dark:text-purple-400 hover:underline">
