...
export default function NoteFraisIndex({ auth, ...props }) {
  return (
    <AuthLayout>
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <span>🧾</span> Notes de Frais
          </h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Gérer vos notes de frais</p>
        </div>
