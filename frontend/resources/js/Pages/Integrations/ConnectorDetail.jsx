    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div key={field.key}>
                    ...
                    {field.type === 'select' ? (
                        <select
                            ...
                            className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-3 py-2.5 text-sm bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none"
                        >
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-3 py-2.5 text-sm bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none resize-none"
                        />
                    ) : (
                        <div className="relative">
                            <input
                                ...
                                className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-3 py-2.5 pr-10 text-sm bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none"
                            />
                            {field.type === 'password' && (
                                <button
                                    type="button"
            ...
            <button
                type="submit"
                disabled={processing}
                className="w-full py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-semibold text-sm transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={fetchLogs} className="text-sm text-purple-600 hover:underline flex items-center gap-1">
                        ...
                        <tbody>
                            {logs.map(log => (
                                <tr key={log.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                    ...
                                    <td className="py-2">
                                        <span className={`text-xs px-1.5 py-0.5 rounded ${log.direction === 'inbound' ? 'bg-purple-50 text-purple-700' : 'bg-indigo-50 text-indigo-700'}`}>
                                            {log.direction}
                                        </span>
                                    </td>
                    ...
                    {meta.total > meta.per_page && (
                        <div className="flex justify-between mt-4 text-sm">
                            <button
                                ...
                                disabled={page === 1}
                                className="text-purple-600 disabled:opacity-30 hover:underline"
                            >
                                Précédent
                            </button>
...
function StatsTab({ stats }) {
    ...
    const statCards = [
        { label: 'Événements (30j)',   value: stats.total_events,           icon: ChartBarIcon,      color: 'text-purple-600' },
                    ...
                    {isInstalled && (
                        <div className="flex flex-col sm:flex-row gap-2 shrink-0">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors"
                            >
