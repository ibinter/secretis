...
const STATUS_CONFIG = {
  ...
  trial:    { label: 'Période d\'essai', bg: 'bg-purple-50 text-purple-700 border-purple-200',        dot: 'bg-purple-500'    },
...
function PaymentRow({ payment }) {
  const statusMap = {
    ...
    proof_submitted:  { label: 'Preuve soumise',  cls: 'bg-purple-50 text-purple-700 border-purple-200' },
