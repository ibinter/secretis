...
export default function UserEdit({ auth, ...props }) {
  return (
    <AuthLayout>
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <span>✏️</span> Modifier Utilisateur
          </h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Modifier les informations de l'utilisateur</p>
        </div>
