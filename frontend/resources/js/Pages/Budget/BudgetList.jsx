...
const STATUS_LABELS = {
  ...
  approved: { label: 'Approuvé',   color: 'bg-purple-100 text-purple-700' },
                ...
                {items.length === 0 && (
                  <tr>
                    <td colSpan={7} className="px-4 py-10 text-center text-gray-400">
                      Aucun budget trouvé. <a href="/budget/create" className="text-[#9333EA] hover:underline">Créer le premier budget →</a>
                    </td>
                  </tr>
                )}
                {items.map((b) => (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        <a
                          ...
                          className="p-1.5 rounded-lg text-gray-400 hover:text-[#9333EA] hover:bg-gray-100 transition"
                        >
