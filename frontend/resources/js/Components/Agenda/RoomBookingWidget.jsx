        ...
        <div className="space-y-3">
            ...
            {rooms.length > 4 && (
                <input
                    ...
                    className="w-full text-sm px-3 py-1.5 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            )}
            ...
            {!isLoading && !isError && (
                <>
                    ...
                    {/* Salle sélectionnée */}
                    {selected && (
                        <div className="flex items-center gap-2 p-2 bg-blue-50 rounded-md border border-blue-200 text-sm text-blue-700">
                            <IconCheck />
                            <span>
                                <strong>
