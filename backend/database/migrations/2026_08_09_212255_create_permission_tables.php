...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Les tables de roles existent DEJA en production : elles y avaient ete
        // creees par `vendor:publish` sans que le resultat soit versionne.
        // Cette migration existe pour qu'une installation NEUVE les obtienne ;
        // sur une base qui les possede, elle ne doit rien tenter.
        //
        // Les noms de tables viennent de la configuration du paquet, pas d'un
        // litteral : on teste donc celui qui est reellement configure.
